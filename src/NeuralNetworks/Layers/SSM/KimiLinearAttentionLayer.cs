...
public partial class KimiLinearAttentionLayer<T> : LayerBase<T>
{
    ...
    public override void UpdateParameters(T learningRate)
    {
        ...
        RegisterTrainableParameter(_gateKVBias, PersistentTensorRole.Biases);
    ...
    public override Vector<T> GetParameterGradients()
    {
        ...
        return Vector<T>.Concatenate(
            ...
            new Vector<T>(_gateKVBiasGradient?.ToArray() ?? Array.Empty<T>()),
    ...
    {
        base.ClearGradients();
        _queryWeightsGradient = null; _keyWeightsGradient = null; _valueWeightsGradient = null; _gateKVBiasGradient = null;
